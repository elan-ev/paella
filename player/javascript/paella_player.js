...
paella.player = null;
paella.version = "6.4.3 - build: dd225347";
...
(function () {
  ...
  var DomNode = /*#__PURE__*/function (_paella$Node) {
    ...
    var _super = _createSuper(DomNode);
    ...
    function DomNode(elementType, id, style) {
      ...
      _this._domElement = document.createElement(elementType);
      _this.domElement.id = id;
      if (style) _this.style = style;
      return _this;
    }
  ...
  var Button = /*#__PURE__*/function (_paella$DomNode) {
    ...
    function Button(id, className, action, isToggle) {
      ...
      var style = {};
      _this2 = _super2.call(this, 'div', id, style);
      _this2.isToggle = isToggle;
      _this2.domElement.className = className;

      if (isToggle) {
        $(_this2.domElement).click(function (event) {
          _this2.toggleIcon();
        });
      }

      $(_this2.domElement).click('click', action);
      return _this2;
    }
...
(function () {
  ...
  function hideButtons() {
    ...
    if (this.buttons) {
      this.buttons.forEach(function (btn) {
        _this.container.removeNode(_this.container.getNode(btn.id));
      });
      this.buttons = null;
    }
  }
  ...
  function showButtons(buttons, profileData) {
    ...
    if (buttons) {
      ...
      buttons.forEach(function (btn, index) {
        ...
        var logoNode = _this2.container.addNode(new paella.DomNode('div', btn.id, style));
  ...
  function applyProfileWithJson(profileData, animate) {
    ...
    var applyVideoRect = function applyVideoRect(profile, videoData, videoWrapper, player) {
      var frameStrategy = _this3.profileFrameStrategy;

      if (frameStrategy) {
        var rect = getClosestRect(profile, videoData.res);
        var videoSize = videoData.res;
        var containerSize = {
          width: $(_this3.domElement).width(),
          height: $(_this3.domElement).height()
        };
    ...
    this.streamProvider.videoStreams.forEach(function (streamData, index) {
      ...
      var player = _this3.streamProvider.videoPlayers[index];
      var videoWrapper = _this3.videoWrappers[index];
  ...
  var Profiles = /*#__PURE__*/function () {
    function Profiles() {
      ...
      paella.events.bind(paella.events.controlBarDidHide, function () {
        return _this4.hideButtons();
      });
      paella.events.bind(paella.events.controlBarDidShow, function () {
        return _this4.showButtons();
      });
      paella.events.bind(paella.events.profileListChanged, function () {
        if (paella.player && paella.player.videoContainer && (!_this4.currentProfile || _this4.currentProfileName != _this4.currentProfile.id)) {
          _this4.setProfile(_this4.currentProfileName, false);
        }
      });
    }
      ...
      value: function setProfile(profileName, animate) {
        ...
        if (!paella.player.videoContainer.ready) {
          ...
          if (!profileData && g_profiles.length == 0) {
            ...
            setTimeout(function () {
              _this5.setProfile(profileName, animate);
            }, 100);
            return false;
          } else {
...
(function () {
  ...
  var BestFitVideoQualityStrategy = /*#__PURE__*/function (_paella$VideoQualityS) {
    ...
    var _super = _createSuper(BestFitVideoQualityStrategy);
  ...
  var LimitedBestFitVideoQualityStrategy = /*#__PURE__*/function (_paella$VideoQualityS2) {
    ...
    var _super2 = _createSuper(LimitedBestFitVideoQualityStrategy);
...
(function () {
  var AudioElementBase = /*#__PURE__*/function (_paella$DomNode) {
    _inherits(AudioElementBase, _paella$DomNode);

    var _super = _createSuper(AudioElementBase);
...
(function () {
  ...
  var MultiformatAudioElement = /*#__PURE__*/function (_paella$AudioElementB) {
    ...
    var _super2 = _createSuper(MultiformatAudioElement);
    ...
    function MultiformatAudioElement(id, stream) {
      ...
      _this2 = _super2.call(this, id, stream);
      _this2._streamName = "audio";
      _this2._audio = document.createElement('audio');

      _this2.domElement.appendChild(_this2._audio);
    ...
    _createClass(MultiformatAudioElement, [{
      ...
      value: function currentTime() {
        ...
        return checkReady.apply(this, [function () {
          return _this8.audio.currentTime;
        }]);
      }
    }, {
      key: "setVolume",
      value: function setVolume(volume) {
        ...
        return checkReady.apply(this, [function () {
          return _this9.audio.volume = volume;
        }]);
      }
    }, {
      key: "volume",
      ...
      value: function setPlaybackRate(rate) {
        ...
        return checkReady.apply(this, [function () {
          _this11.audio.playbackRate = rate;
        }]);
      }
    }, {
      key: "playbackRate",
      value: function playbackRate() {
        ...
        return checkReady.apply(this, [function () {
          return _this12.audio.playbackRate;
        }]);
      }
    }, {
      key: "unload",
...
(function () {
  ...
  var VideoRect = /*#__PURE__*/function (_paella$DomNode) {
    _inherits(VideoRect, _paella$DomNode);

    var _super = _createSuper(VideoRect);
    ...
    function VideoRect(id, domType, left, top, width, height) {
      ...
      _this = _super.call(this, domType, id, {});
      var zoomSettings = paella.player.config.player.videoZoom || {};

      var zoomEnabled = (zoomSettings.enabled !== undefined ? zoomSettings.enabled : true) && _this.allowZoom();

      _this.style = zoomEnabled ? {
        width: _this._zoom + '%',
        height: "100%",
        position: 'absolute'
      } : {
      ...
      setTimeout(function () {
        return _this.domElement.parentElement.appendChild(eventCapture);
      }, 10);
      ...
      _this.eventCapture = eventCapture;
      ...
      if (zoomEnabled) {
        ...
        _this._zoomAvailable = true;
        checkZoomAvailable.apply(_assertThisInitialized(_this));
        ...
        _this._maxZoom = zoomSettings.max || 400;
        $(_this.domElement).css({
          width: "100%",
          height: "100%",
          left: "0%",
          top: "0%"
        });
        Object.defineProperty(_assertThisInitialized(_this), 'zoom', {
          get: function get() {
            return this._zoom;
          }
        });
        Object.defineProperty(_assertThisInitialized(_this), 'zoomOffset', {
          get: function get() {
        ...
        $(eventCapture).on('touchstart', function (evt) {
          if (!_this.allowZoom() || !_this._zoomAvailable) return;
          touches = [];
          var videoOffset = $(_this.domElement).offset();
        ...
        $(eventCapture).on('touchmove', function (evt) {
          ...
          if (curTouches.length > 1 && touches.length > 1) {
            ...
            _this._mouseCenter = center;
            _this._zoom += delta;
            _this._zoom = _this._zoom < 100 ? 100 : _this._zoom;
            _this._zoom = _this._zoom > _this._maxZoom ? _this._maxZoom : _this._zoom;
            var newVideoSize = {
              w: $(_this.domElement).width(),
              h: $(_this.domElement).height()
            };
            var mouse = _this._mouseCenter;
            $(_this.domElement).css({
              width: _this._zoom + '%',
              height: _this._zoom + '%'
            });
            var maxOffset = _this._zoom - 100;
            var offset = {
            ...
            paella.events.trigger(paella.events.videoZoomChanged, {
              video: _assertThisInitialized(_this)
            });
            touches = curTouches;
            evt.preventDefault();
            ...
            panImage.apply(_assertThisInitialized(_this), [desp]);
            touches = curTouches;
            evt.preventDefault();
          }
        });
        ...
        _this.zoomIn = function () {
          if (_this._zoom >= _this._maxZoom || !_this._zoomAvailable) return;

          if (!_this._mouseCenter) {
            _this._mouseCenter = {
              x: $(_this.domElement).width() / 2,
              y: $(_this.domElement).height() / 2
            };
          }
        ...
        _this.zoomOut = function () {
          if (_this._zoom <= 100 || !_this._zoomAvailable) return;
        ...
        $(eventCapture).on('mousewheel wheel', function (evt) {
          ...
          if (_this._zoom >= _this._maxZoom && wheel > 0) return;
          _this._zoom += wheel;
          _this._zoom = _this._zoom < 100 ? 100 : _this._zoom;
          _this._zoom = _this._zoom > _this._maxZoom ? _this._maxZoom : _this._zoom;
          var newVideoSize = {
          ...
          _this._mouseCenter = mouse;
          evt.stopPropagation();
          return false;
        });
        $(eventCapture).on('mousedown', function (evt) {
          _this._mouseDown = mousePos(evt);
          _this.drag = true;
        });
        $(eventCapture).on('mousemove', function (evt) {
          if (!_this.allowZoom() || !_this._zoomAvailable) return; //this.drag = evt.buttons>0;

          if (_this.drag) {
            paella.player.videoContainer.disablePlayOnClick();
            var mouse = mousePos(evt);
            panImage.apply(_assertThisInitialized(_this), [{
              x: mouse.x - _this._mouseDown.x,
              y: mouse.y - _this._mouseDown.y
            }]);
            _this._mouseDown = mouse;
          }
        });
  ...
  var VideoElementBase = /*#__PURE__*/function (_paella$VideoRect) {
    ...
    var _super2 = _createSuper(VideoElementBase);
    ...
    function VideoElementBase(id, stream, containerType, left, top, width, height) {
      ...
      _this2 = _super2.call(this, id, containerType, left, top, width, height);
      _this2._stream = stream;
      _this2._ready = false;
      _this2._autoplay = false;
      _this2._videoQualityStrategy = null;
      if (_this2._stream.preview) _this2.setPosterFrame(_this2._stream.preview);

      if (_this2.canvasData.mouseEventsSupport) {
        _this2.disableEventCapture();
      }
  ...
  var EmptyVideo = /*#__PURE__*/function (_paella$VideoElementB) {
    ...
    var _super3 = _createSuper(EmptyVideo);

    function EmptyVideo(id, stream, left, top, width, height) {
      _classCallCheck(this, EmptyVideo);

      return _super3.call(this, id, stream, 'div', left, top, width, height);
    } // Initialization functions
  ...
  var EmptyVideoFactory = /*#__PURE__*/function (_paella$VideoFactory) {
    ...
    var _super4 = _createSuper(EmptyVideoFactory);
  ...
  var Html5Video = /*#__PURE__*/function (_paella$VideoElementB2) {
    ...
    var _super5 = _createSuper(Html5Video);
    ...
    function Html5Video(id, stream, left, top, width, height, streamName) {
      ...
      _this3 = _super5.call(this, id, stream, 'video', left, top, width, height);
    ...
    _createClass(Html5Video, [{
      ...
      value: function _configureVideoEvents(videoElement) {
        ...
        $(this.video).bind('emptied', function (evt) {
          if (_this4._resumeCurrentTime && !isNaN(_this4._resumeCurrentTime)) {
            _this4.video.currentTime = _this4._resumeCurrentTime;
          }
        }); // Fix safari setQuelity bug

        if (paella.utils.userAgent.browser.Safari) {
          $(this.video).bind('canplay canplaythrough', function (evt) {
            _this4._resumeCurrentTime && (_this4.video.currentTime = _this4._resumeCurrentTime);
          });
        }
      }
    }, {
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          if (_this5.ready) {
            ...
            $(_this5.video).bind('canplay', function () {
              processResult(action());
              $(_this5.video).unbind('canplay');
              $(_this5.video).unbind('loadedmetadata');
            });
          }
        });
      }
      ...
      value: function captureFrame() {
        ...
        return new Promise(function (resolve) {
          resolve({
            source: _this6.video,
            width: _this6.video.videoWidth,
            height: _this6.video.videoHeight
          });
        });
      }
    }, {
      ...
      value: function getVideoData() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this7._deferredAction(function () {
            resolve({
      ...
      value: function load() {
        ...
        return new Promise(function (resolve, reject) {
          var sources = _this8._stream.sources[_this8._streamName];

          if (_this8._currentQuality === null && _this8._videoQualityStrategy) {
            _this8._currentQuality = _this8._videoQualityStrategy.getQualityIndex(sources);
          }

          var stream = _this8._currentQuality < sources.length ? sources[_this8._currentQuality] : null;
          _this8.video.innerText = "";

          _this8.videoCanvas().then(function (CanvasClass) {
            var canvasInstance = new CanvasClass(stream);
            _this8._zoomAvailable = canvasInstance.allowZoom();

            if (window.$paella_bg && bg.app && canvasInstance instanceof bg.app.WindowController) {
              // WebGL canvas
              _this8.domElementType = 'canvas';

              if (stream) {
                // WebGL engine load callback
                return new Promise(function (webglResolve, webglReject) {
                  _this8.webGlDidLoad().then(function () {
                    _this8.canvasController = null;
                    var mainLoop = bg.app.MainLoop.singleton;
                    mainLoop.updateMode = bg.app.FrameUpdate.AUTO;
                    mainLoop.canvas = _this8.domElement;
                    mainLoop.run(canvasInstance);
                    return _this8.loadVideoStream(canvasInstance, stream);
            ...
            if (canvas && paella.WebGLCanvas && canvas instanceof paella.WebGLCanvas) {
              _this8._video = canvas.video;

              _this8._video.pause();

              _this8._configureVideoEvents(_this8.video);
            }
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve, reject) {
          setTimeout(function () {
            var result = [];
            var sources = _this9._stream.sources[_this9._streamName];
            var index = -1;
            sources.forEach(function (s) {
              index++;
              result.push(_this9._getQualityObject(index, s));
            });
            resolve(result);
          }, 10);
        });
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve) {
          var paused = _this10.video.paused;
          var sources = _this10._stream.sources[_this10._streamName];
          _this10._currentQuality = index < sources.length ? index : 0;
          var currentTime = _this10.video.currentTime;
          var This = _this10;
          ...
          _this10.freeze().then(function () {
            ...
            _this10.video.addEventListener('seeked', onSeek);

            _this10.video.currentTime = currentTime;
          });
        });
      }
    }, {
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve) {
          resolve(_this11._getQualityObject(_this11._currentQuality, _this11._stream.sources[_this11._streamName][_this11._currentQuality]));
        });
      }
    }, {
      key: "play",
      value: function play() {
        ...
        return this._deferredAction(function () {
          if (!_this12._isDisabled) {
            return _this12.video.play();
          } else {
            return Promise.resolve();
          }
        });
      ...
      value: function pause() {
        ...
        return this._deferredAction(function () {
          if (!_this13._isDisabled) {
            return _this13.video.pause();
          } else {
            return Promise.resolve();
          }
        });
      ...
      value: function setCurrentTime(time) {
        ...
        return this._deferredAction(function () {
          (time == 0 || time) && !isNaN(time) && (_this16.video.currentTime = time);
        });
      }
    }, {
      key: "currentTime",
...
*/
(function () {
  var BackgroundContainer = /*#__PURE__*/function (_paella$DomNode) {
    _inherits(BackgroundContainer, _paella$DomNode);

    var _super = _createSuper(BackgroundContainer);
    ...
    function BackgroundContainer(id, image) {
      ...
      _this.domElement.setAttribute('src', image);

      _this.domElement.setAttribute('alt', '');

      _this.domElement.setAttribute('width', '100%');

      _this.domElement.setAttribute('height', '100%');
  ...
  var VideoOverlay = /*#__PURE__*/function (_paella$DomNode2) {
    _inherits(VideoOverlay, _paella$DomNode2);

    var _super2 = _createSuper(VideoOverlay);
    ...
    function VideoOverlay() {
      ...
      _this2 = _super2.call(this, 'div', 'overlayContainer', style);

      _this2.domElement.setAttribute("role", "main");
  ...
  var VideoWrapper = /*#__PURE__*/function (_paella$DomNode3) {
    _inherits(VideoWrapper, _paella$DomNode3);

    var _super3 = _createSuper(VideoWrapper);
    ...
    function VideoWrapper(id, left, top, width, height) {
      ...
      _this3 = _super3.call(this, 'div', id, style);
      _this3._rect = {
        left: left,
        top: top,
        width: width,
      ...
      _this3.domElement.className = "videoWrapper";
      return _this3;
    }
  ...
  var VideoContainerBase = /*#__PURE__*/function (_paella$DomNode4) {
    _inherits(VideoContainerBase, _paella$DomNode4);

    var _super4 = _createSuper(VideoContainerBase);
    ...
    function VideoContainerBase(id) {
      ...
      _this5 = _super4.call(this, 'div', id, style);
      _this5._trimming = {
        enabled: false,
        start: 0,
        end: 0
      };
      _this5.timeupdateEventTimer = null;
      _this5.timeupdateInterval = 250;
      _this5.masterVideoData = null;
      _this5.slaveVideoData = null;
      _this5.currentMasterVideoData = null;
      _this5.currentSlaveVideoData = null;
      _this5._force = false;
      _this5._playOnClickEnabled = true;
      _this5._seekDisabled = false;
      _this5._seekType = paella.SeekType.FULL;
      _this5._seekTimeLimit = 0;
      _this5._attenuationEnabled = false;
      $(_this5.domElement).dblclick(function (evt) {
        if (_this5.firstClick) {
          paella.player.isFullScreen() ? paella.player.exitFullScreen() : paella.player.goFullScreen();
        }
      });
      var dblClickTimer = null;
      $(_this5.domElement).click(function (evt) {
        var doClick = function doClick() {
          if (_this5.firstClick && !_this5._playOnClickEnabled) return;
          paella.player.videoContainer.paused().then(function (paused) {
            // If some player needs mouse events support, the click is ignored
            if (_this5.firstClick && _this5.streamProvider.videoPlayers.some(function (p) {
              return p.canvasData.mouseEventsSupport;
            })) {
              return;
            }

            _this5.firstClick = true;
      ...
      _this5.domElement.addEventListener("touchstart", function (event) {
    ...
    _createClass(VideoContainerBase, [{
      ...
      value: function triggerTimeupdate() {
        ...
        this.paused().then(function (p) {
          paused = p;
          return _this6.duration();
        }).then(function (d) {
          duration = d;
          return _this6.currentTime();
        }).then(function (currentTime) {
          if (!paused || _this6._force) {
            _this6._seekTimeLimit = currentTime > _this6._seekTimeLimit ? currentTime : _this6._seekTimeLimit;
            _this6._force = false;
            paella.events.trigger(paella.events.timeupdate, {
              videoContainer: _this6,
      ...
      value: function seekTo(newPositionPercent) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          paella.player.videoContainer.currentTime().then(function (t) {
            ...
            if (_this8._seekTimeLimit > 0 && _this8._seekType == paella.SeekType.BACKWARDS_ONLY) {
              time = _this8._seekTimeLimit;
            }

            var currentPercent = time / duration * 100;

            switch (_this8._seekType) {
            ...
            _this8.setCurrentPercent(newPositionPercent).then(function (timeData) {
              _this8._force = true;

              _this8.triggerTimeupdate();
      ...
      value: function seekToTime(time) {
        ...
        return new Promise(function (resolve, reject) {
          paella.player.videoContainer.currentTime().then(function (currentTime) {
            if (_this9._seekTimeLimit && _this9._seekType == paella.SeekType.BACKWARDS_ONLY) {
              currentTime = _this9._seekTimeLimit;
            }

            switch (_this9._seekType) {
              case paella.SeekType.FULL:
                break;
            ...
            _this9.setCurrentTime(time).then(function (timeData) {
              _this9._force = true;

              _this9.triggerTimeupdate();
      ...
      value: function trimStart() {
        ...
        return new Promise(function (resolve) {
          resolve(_this10._trimming.start);
        });
      }
    }, {
      key: "trimEnd",
      ...
      value: function trimEnabled() {
        ...
        return new Promise(function (resolve) {
          resolve(_this12._trimming.enabled);
        });
      }
    }, {
      key: "trimming",
      ...
      value: function setTrimming(start, end) {
        ...
        return new Promise(function (resolve) {
          ...
          _this14.currentTime(true).then(function (c) {
            currentTime = c;
            return _this14.duration();
          }).then(function (duration) {
            _this14._trimming.start = Math.floor(start);
            _this14._trimming.end = Math.floor(end);

            if (_this14._trimming.enabled) {
              if (currentTime < _this14._trimming.start) {
                _this14.setCurrentTime(0);
              }

              if (currentTime > _this14._trimming.end) {
                _this14.setCurrentTime(duration);
              }
            ...
            paella.events.trigger(paella.events.setTrim, {
              trimEnabled: _this14._trimming.enabled,
              trimStart: _this14._trimming.start,
              trimEnd: _this14._trimming.end
            });
            resolve();
          });
        });
      ...
      value: function setCurrentPercent(percent) {
        ...
        var duration = 0;
        return new Promise(function (resolve) {
          _this15.duration().then(function (d) {
            duration = d;
            return _this15.trimming();
            ...
            return _this15.setCurrentTime(position);
      ...
      value: function ended() {
        ...
        return new Promise(function (resolve) {
          ...
          _this16.duration().then(function (d) {
            duration = d;
            return _this16.currentTime();
          }).then(function (currentTime) {
  ...
  var LimitedSizeProfileFrameStrategy = /*#__PURE__*/function (_ProfileFrameStrategy) {
    ...
    var _super5 = _createSuper(LimitedSizeProfileFrameStrategy);
    ...
    _createClass(StreamProvider, [{
      ...
      value: function init(videoData) {
        ...
        this._videoData.forEach(function (stream, index) {
          ...
          if (stream.role == 'master') {
            _this17._mainStream = stream;
          }

          if (stream.type == 'video') {
            _this17._videoStreams.push(stream);
          } else if (stream.type == 'audio') {
            _this17._audioStreams.push(stream);
          }
        });
        ...
        this._videoStreams.forEach(function (videoStream, index) {
          ...
          player.setVideoQualityStrategy(_this17._qualityStrategy);
          player.setAutoplay(autoplay);

          if (videoStream == _this17._mainStream) {
            _this17._mainPlayer = player;
          }

          _this17._audioPlayer.push(player);

          _this17._videoPlayers.push(player);

          _this17._players.push(player);
        }); // Create audio player
        ...
        this._audioStreams.forEach(function (audioStream, index) {
          ...
          if (player) {
            _this17._audioPlayers.push(player);
      ...
      value: function startVideoSync(syncProviderPlayer) {
        ...
        var sync = function sync() {
          _this18._syncProviderPlayer.currentTime().then(function (t) {
            _this18.players.forEach(function (player) {
          ...
          _this18._syncTimer = setTimeout(function () {
            return sync();
          }, 1000);
        };
      ...
      value: function callPlayerFunction(fnName) {
        ...
        return new Promise(function (resolve, reject) {
          Promise.all(promises).then(function () {
            if (fnName == 'play' && !_this19._firstPlay) {
              _this19._firstPlay = true;

              if (_this19._startTime) {
                _this19.players.forEach(function (p) {
                  return p.setCurrentTime(_this19._startTime);
                });
              }
            }
  ...
  var VideoContainer = /*#__PURE__*/function (_paella$VideoContaine) {
    ...
    var _super6 = _createSuper(VideoContainer);
    ...
    function VideoContainer(id) {
      ...
      _this20 = _super6.call(this, id);
      _this20._streamProvider = new paella.StreamProvider();
      _this20._ready = false;
      _this20._videoWrappers = [];
      _this20._container = new paella.DomNode('div', 'playerContainer_videoContainer_container', {
        position: 'relative',
        display: 'block',
        marginLeft: 'auto',
        marginRight: 'auto',
      ...
      _this20._container.domElement.setAttribute('role', 'main');

      _this20.addNode(_this20._container);

      _this20.overlayContainer = new paella.VideoOverlay(_this20.domElement);

      _this20.container.addNode(_this20.overlayContainer);

      _this20.setProfileFrameStrategy(paella.ProfileFrameStrategy.Factory());

      _this20.setVideoQualityStrategy(paella.VideoQualityStrategy.Factory());

      _this20._audioTag = paella.player.config.player.defaultAudioTag || paella.dictionary.currentLanguage();
      _this20._audioPlayer = []; // Initial volume level

      _this20._volume = paella.utils.cookies.get("volume") ? Number(paella.utils.cookies.get("volume")) : 1;
      _this20._muted = false;
      return _this20;
    ...
    _createClass(VideoContainer, [{
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          _this21.ended().then(function (ended) {
            if (ended) {
              _this21._streamProvider.startTime = 0;

              _this21.seekToTime(0);
            } else {
              _this21.streamProvider.startTime = _this21._startTime;
            }

            return _this21.streamProvider.callPlayerFunction('play');
          }).then(function () {
            _get(_getPrototypeOf(VideoContainer.prototype), "play", _this21).call(_this21);
      ...
      value: function pause() {
        ...
        return new Promise(function (resolve, reject) {
          _this22.streamProvider.callPlayerFunction('pause').then(function () {
            _get(_getPrototypeOf(VideoContainer.prototype), "pause", _this22).call(_this22);
      ...
      value: function setCurrentTime(time) {
        ...
        return new Promise(function (resolve, reject) {
          _this23.trimming().then(function (trimmingData) {
            ...
            return _this23.streamProvider.callPlayerFunction('setCurrentTime', time);
          }).then(function () {
            return _this23.duration(false);
          }).then(function (duration) {
            resolve({
              time: time,
              duration: duration
      ...
      value: function currentTime() {
        ...
        return new Promise(function (resolve) {
          ...
          p.then(function (t) {
            trimmingData = t;
            return _this24.masterVideo().currentTime();
          }).then(function (time) {
            if (trimmingData.enabled) {
      ...
      value: function mute() {
        ...
        return new Promise(function (resolve) {
          ...
          var _iterator = _createForOfIteratorHelper(_this25._audioPlayer),
              _step;
      ...
      value: function unmute() {
        ...
        return new Promise(function (resolve) {
          _this26._muted = false;

          var _iterator2 = _createForOfIteratorHelper(_this26._audioPlayer),
              _step2;

          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var player = _step2.value;
              player.setVolume(_this26._volume).then(function () {
                paella.events.trigger(paella.events.setVolume, {
                  master: _this26._volume
                });
                resolve();
              });
            }
      ...
      value: function setVolume(params) {
        ...
        if (_typeof(params) == 'object') {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this27._volume = params;

            var _iterator3 = _createForOfIteratorHelper(_this27._audioPlayer),
                _step3;

            try {
              for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                var player = _step3.value;
                player.setVolume(params).then(function () {
                  paella.events.trigger(paella.events.setVolume, {
                    master: params
                  });
                  resolve(params);
      ...
      value: function duration() {
        ...
        return new Promise(function (resolve) {
          ...
          p.then(function (t) {
            trimmingData = t;
            return _this28.masterVideo().duration();
          }).then(function (duration) {
            if (trimmingData.enabled) {
      ...
      value: function getAudioTags() {
        ...
        return new Promise(function (resolve) {
          var lang = [];
          var p = _this29.streamProvider.players;
      ...
      value: function setAudioTag(lang) {
        ...
        return new Promise(function (resolve) {
          var promises = [];
          _this30._audioPlayer = _this30.streamProvider.players;

          var _iterator4 = _createForOfIteratorHelper(_this30._audioPlayer),
              _step4;

          try {
            for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
              var player = _step4.value;
              promises.push(player.setVolume(_this30._volume));
            }
          } catch (err) {
            _iterator4.e(err);
          } finally {
          ...
          Promise.all(promises).then(function () {
            _this30._audioTag = _this30._audioPlayer[0].stream.audioTag;
            paella.events.trigger(paella.events.audioTagChanged);

            _this30.streamProvider.startVideoSync(_this30.audioPlayer);
      ...
      value: function setStreamData(videoData) {
        ...
        return new Promise(function (resolve, reject) {
          _this31.streamProvider.init(videoData);
          ...
          videoData.forEach(function (video) {
            ...
            if (video.audioTag == _this31._audioTag) {
              streamDataAudioTag = _this31._audioTag;
            }
          });

          if (streamDataAudioTag != _this31._audioTag && streamDataAudioTag != null) {
            _this31._audioTag = streamDataAudioTag;
          }

          _this31.streamProvider.videoPlayers.forEach(function (player, index) {
            addVideoWrapper.apply(_this31, ['videoPlayerWrapper_' + index, player]);
            player.setAutoplay(_this31.autoplay());
          });

          _this31.streamProvider.loadVideos()["catch"](function (err) {
            reject(err);
          }).then(function () {
            return _this31.setAudioTag(_this31.audioTag);
          }).then(function () {
            var endedTimer = null;

            var setupEndEventTimer = function setupEndEventTimer() {
              _this31.stopTimeupdate();
            ...
            var eventBindingObject = _this31.masterVideo().video || _this31.masterVideo().audio;

            $(eventBindingObject).bind('timeupdate', function (evt) {
              _this31.trimming().then(function (trimmingData) {
                ...
                if (current >= duration) {
                  _this31.streamProvider.callPlayerFunction('pause');
      ...
      value: function getVideoData() {
        ...
        return new Promise(function (resolve, reject) {
          ...
          _this32.currentTime().then(function (currentTime) {
            videoData.currentTime = currentTime;
            return _this32.volume();
          }).then(function (v) {
            videoData.volume = v;
            return _this32.duration();
          }).then(function (d) {
            videoData.duration = d;
            return _this32.paused();
          }).then(function (p) {
            videoData.paused = p;
            return _this32.trimming();
          }).then(function (trimming) {
...
(function () {
  var PluginManager = /*#__PURE__*/function () {
    ...
    function PluginManager() {
      ...
      paella.events.bind(paella.events.loadPlugins, function (event) {
        _this.loadPlugins("paella.DeferredLoadPlugin");
      });
      var timer = new base.Timer(function () {
        if (paella.player && paella.player.controls && _this.doResize) paella.player.controls.onresize();
      }, 1000);
      timer.repeat = true;
    }
      ...
      value: function addPlugin(plugin) {
        ...
        plugin.checkEnabled(function (isEnabled) {
          if (plugin.type == "eventDriven" && isEnabled) {
            ...
            _this2.eventDrivenPlugins.push(plugin);
  ...
  var FastLoadPlugin = /*#__PURE__*/function (_paella$Plugin) {
    ...
    var _super = _createSuper(FastLoadPlugin);
  ...
  var EarlyLoadPlugin = /*#__PURE__*/function (_paella$Plugin2) {
    ...
    var _super2 = _createSuper(EarlyLoadPlugin);
  ...
  var DeferredLoadPlugin = /*#__PURE__*/function (_paella$Plugin3) {
    ...
    var _super3 = _createSuper(DeferredLoadPlugin);
  ...
  var PopUpContainer = /*#__PURE__*/function (_paella$DomNode) {
    _inherits(PopUpContainer, _paella$DomNode);

    var _super4 = _createSuper(PopUpContainer);
    ...
    function PopUpContainer(id, className) {
      ...
      var style = {};
      _this3 = _super4.call(this, 'div', id, style);
      _this3.containers = null;
      _this3.currentContainerId = -1;
      _this3.domElement.className = className;
      _this3.containers = {};
      return _this3;
    }
  ...
  var TimelineContainer = /*#__PURE__*/function (_paella$PopUpContaine) {
    ...
    var _super5 = _createSuper(TimelineContainer);
  ...
  var UIPlugin = /*#__PURE__*/function (_paella$DeferredLoadP) {
    ...
    var _super6 = _createSuper(UIPlugin);
  ...
  var ButtonPlugin = /*#__PURE__*/function (_paella$UIPlugin) {
    ...
    var _super7 = _createSuper(ButtonPlugin);
    ...
    function ButtonPlugin() {
      ...
      _this4.containerManager = null;
      _this4._domElement = null;
      return _this4;
    }
    ...
    _createClass(ButtonPlugin, [{
      ...
      value: function rebuildMenu() {
        ...
        menuContent.forEach(function (menuItem) {
          _this5.menuContent.appendChild(getButtonItem(menuItem, _this5));
        });
      }
    }, {
      key: "menuContent",
  ...
  var VideoOverlayButtonPlugin = /*#__PURE__*/function (_paella$ButtonPlugin) {
    ...
    var _super8 = _createSuper(VideoOverlayButtonPlugin);
  ...
  var EventDrivenPlugin = /*#__PURE__*/function (_paella$EarlyLoadPlug) {
    ...
    var _super9 = _createSuper(EventDrivenPlugin);
    ...
    function EventDrivenPlugin() {
      ...
      var events = _this6.getEvents();

      for (var i = 0; i < events.length; ++i) {
        var event = events[i];

        if (event == paella.events.loadStarted) {
          _this6.onEvent(paella.events.loadStarted);
        }
      }
...
(function () {
  ...
  function initWebGLCanvas() {
    if (!paella.WebGLCanvas) {
      var WebGLCanvas = /*#__PURE__*/function (_bg$app$WindowControl) {
        ...
        var _super = _createSuper(WebGLCanvas);
        ...
        _createClass(WebGLCanvas, [{
          ...
          value: function buildScene() {
            ...
            this.loadVideoTexture().then(function (texture) {
              _this3._texture = texture;

              _this3.buildVideoSurface(_this3._root, texture);
            });
  ...
  function buildVideoCanvas(stream) {
    if (!paella.WebGLCanvas) {
      var WebGLCanvas = /*#__PURE__*/function (_bg$app$WindowControl2) {
        ...
        var _super2 = _createSuper(WebGLCanvas);
        ...
        _createClass(WebGLCanvas, [{
          ...
          value: function buildScene() {
            ...
            this.registerPlugins();
            this.loadVideoTexture().then(function (texture) {
              _this6._texture = texture;

              _this6.buildVideoSurface(_this6._root, texture);
            });
            var lightNode = new bg.scene.Node(this.gl, "Light");
            var light = new bg.base.Light();
            light.ambient = bg.Color.White();
  ...
  paella.addCanvasPlugin("video", false, false, function () {
    return /*#__PURE__*/function (_paella$VideoCanvas) {
      ...
      var _super3 = _createSuper(VideoCanvas);

      function VideoCanvas(stream) {
        _classCallCheck(this, VideoCanvas);

        return _super3.call(this, stream);
      }
...
(function () {
  ...
  var SearchCallback = /*#__PURE__*/function (_base$AsyncLoaderCall) {
    ...
    var _super = _createSuper(SearchCallback);
    ...
    function SearchCallback(caption, text) {
      ...
      _this = _super.call(this);
      _this.name = "captionSearchCallback";
      ...
      value: function search(txt, next) {
        ...
        if (this._index == undefined) {
          ...
          paella.player.videoContainer.trimming().then(function (trimming) {
            _this3._index.search(txt).forEach(function (s) {
  ...
  var CaptionParserPlugIn = /*#__PURE__*/function (_paella$FastLoadPlugi) {
    ...
    var _super2 = _createSuper(CaptionParserPlugIn);
...
(function () {
  ...
  var SearchServicePlugIn = /*#__PURE__*/function (_paella$FastLoadPlugi) {
    _inherits(SearchServicePlugIn, _paella$FastLoadPlugi);

    var _super2 = _createSuper(SearchServicePlugIn);
...
(function () {
  ...
  var SaverPlugIn = /*#__PURE__*/function (_paella$FastLoadPlugi) {
    _inherits(SaverPlugIn, _paella$FastLoadPlugi);

    var _super = _createSuper(SaverPlugIn);
...
*/
(function () {
  var TimeControl = /*#__PURE__*/function (_paella$DomNode) {
    _inherits(TimeControl, _paella$DomNode);

    var _super = _createSuper(TimeControl);
    ...
    function TimeControl(id) {
      ...
      _this.domElement.className = 'timeControlOld';
      _this.domElement.className = 'timeControl'; //this.domElement.innerText = "0:00:00";

      var thisClass = _assertThisInitialized(_this);
  ...
  var PlaybackCanvasPlugin = /*#__PURE__*/function (_paella$DeferredLoadP) {
    _inherits(PlaybackCanvasPlugin, _paella$DeferredLoadP);

    var _super2 = _createSuper(PlaybackCanvasPlugin);
    ...
    _createClass(PlaybackBarCanvas, [{
      ...
      value: function drawCanvas() {
        ...
        paella.player.videoContainer.duration(true).then(function (d) {
          ...
          var ctx = _this3.context;
          var w = _this3.width;
          var h = _this3.height;

          _this3.clearCanvas();

          _this3._plugins.forEach(function (plugin) {
      ...
      get: function get() {
        ...
        if (!this._canvas) {
          var createCanvas = function createCanvas(index) {
            ...
            result.width = $(_this4.parent).width();
            result.height = $(_this4.parent).height();
            return result;
          };
  ...
  var PlaybackBar = /*#__PURE__*/function (_paella$DomNode2) {
    _inherits(PlaybackBar, _paella$DomNode2);

    var _super3 = _createSuper(PlaybackBar);
    ...
    function PlaybackBar(id) {
      ...
      var style = {};
      _this5 = _super3.call(this, 'div', id, style);
      _this5.playbackFullId = '';
      _this5.updatePlayBar = true;
      _this5.timeControlId = '';
      _this5._images = null;
      _this5._prev = null;
      _this5._next = null;
      _this5._videoLength = null;
      _this5._lastSrc = null;
      _this5._aspectRatio = 1.777777778;
      _this5._hasSlides = null;
      _this5._imgNode = null;
      _this5._canvas = null;
      _this5.domElement.className = "playbackBar";

      _this5.domElement.setAttribute("alt", ""); //this.domElement.setAttribute("title", "Timeline Slider");


      _this5.domElement.setAttribute("aria-label", "Timeline Slider");

      _this5.domElement.setAttribute("role", "slider");

      _this5.domElement.setAttribute("aria-valuemin", "0");

      _this5.domElement.setAttribute("aria-valuemax", "100");

      _this5.domElement.setAttribute("aria-valuenow", "0");

      _this5.domElement.setAttribute("tabindex", paella.tabIndex.next);

      $(_this5.domElement).keyup(function (event) {
        var currentTime = 0;
        var duration = 0;
        paella.player.videoContainer.currentTime().then(function (t) {
          currentTime = t;
      ...
      _this5.playbackFullId = id + "_full";
      _this5.timeControlId = id + "_timeControl";
      var playbackFull = new paella.DomNode('div', _this5.playbackFullId, {
        width: '0%'
      });
      playbackFull.domElement.className = "playbackBarFull";

      _this5.addNode(playbackFull);

      _this5.addNode(new paella.TimeControl(_this5.timeControlId));

      var thisClass = _assertThisInitialized(_this5);

      paella.events.bind(paella.events.timeupdate, function (event, params) {
        thisClass.onTimeUpdate(params);
      });
      $(_this5.domElement).bind('mousedown', function (event) {
      ...
      if (!base.userAgent.browser.IsMobileVersion) {
        $(_this5.domElement).bind('mousemove', function (event) {
        ...
        $(_this5.domElement).bind("mouseout", function (event) {
      ...
      _this5.domElement.addEventListener('touchmove', function (event) {
        thisClass.movePassive(event);
        paella.utils.mouseManager.move(event);
      }, false);

      _this5.domElement.addEventListener('touchend', function (event) {
        paella.utils.mouseManager.up(event);
        thisClass.clearTimeOverlay();
      }, false);

      $(_this5.domElement).bind('mouseup', function (event) {
        paella.utils.mouseManager.up(event);
      });
      ...
      _this5._canvas = new PlaybackBarCanvas(_this5.domElement);
      return _this5;
    }
        ...
        return new Promise(function (resolve) {
          paella.player.videoContainer.duration().then(function (duration) {
            ...
            if (!n || Object.keys(n).length === 0) {
              _this6._hasSlides = false;
              return;
            } else {
              _this6._hasSlides = true;
            }

            _this6._images = n; // COPY TO LOCAL

            _this6._videoLength = duration; // SORT KEYS FOR SEARCH CLOSEST

            _this6._keys = Object.keys(_this6._images);
            _this6._keys = _this6._keys.sort(function (a, b) {
  ...
  var PlaybackControl = /*#__PURE__*/function (_paella$DomNode3) {
    _inherits(PlaybackControl, _paella$DomNode3);

    var _super4 = _createSuper(PlaybackControl);
      ...
      value: function addPlugin(plugin) {
        ...
        plugin.checkEnabled(function (isEnabled) {
          ...
          if (isEnabled) {
            $(plugin.button).show();
            paella.pluginManager.setupPlugin(plugin);
            var id = 'buttonPlugin' + _this8.buttonPlugins.length;

            if (plugin.getButtonType() == paella.ButtonPlugin.type.popUpButton) {
              parent = _this8.popUpPluginContainer.domElement;
              var popUpContent = paella.ButtonPlugin.BuildPluginPopUp(parent, plugin, id + '_container');

              _this8.popUpPluginContainer.registerContainer(plugin.getName(), popUpContent, button, plugin);
            } else if (plugin.getButtonType() == paella.ButtonPlugin.type.timeLineButton) {
              parent = _this8.timeLinePluginContainer.domElement;
              var timeLineContent = paella.ButtonPlugin.BuildPluginPopUp(parent, plugin, id + '_timeline');

              _this8.timeLinePluginContainer.registerContainer(plugin.getName(), timeLineContent, button, plugin);
            ...
            _this8.pluginsContainer.domElement.removeChild(plugin.button);
          }
        });
      }
    }]);
    ...
    function PlaybackControl(id) {
      ...
      var style = {};
      _this7 = _super4.call(this, 'div', id, style);
      _this7.playbackBarId = '';
      _this7.pluginsContainer = null;
      _this7._popUpPluginContainer = null;
      _this7._timeLinePluginContainer = null;
      _this7.playbackPluginsWidth = 0;
      _this7.popupPluginsWidth = 0;
      _this7.minPlaybackBarSize = 120;
      _this7.playbackBarInstance = null;
      _this7.buttonPlugins = [];
      _this7.domElement.className = 'playbackControls';
      _this7.playbackBarId = id + '_playbackBar';

      var thisClass = _assertThisInitialized(_this7);

      _this7.pluginsContainer = new paella.DomNode('div', id + '_playbackBarPlugins');
      _this7.pluginsContainer.domElement.className = 'playbackBarPlugins';

      _this7.pluginsContainer.domElement.setAttribute("role", "toolbar");

      _this7.addNode(_this7.pluginsContainer);

      _this7.addNode(new paella.PlaybackBar(_this7.playbackBarId));

      paella.pluginManager.setTarget('button', _assertThisInitialized(_this7));
      $(window).mousemove(function (evt) {
        if (_this7._expandedPlugin && $(window).height() - evt.clientY > 50) {
          _this7._expandedPlugin.contract();

          _this7._expandPlugin = null;
        }
      });
      return _this7;
    }
  ...
  var ControlsContainer = /*#__PURE__*/function (_paella$DomNode4) {
    _inherits(ControlsContainer, _paella$DomNode4);

    var _super5 = _createSuper(ControlsContainer);
    ...
    function ControlsContainer(id) {
      ...
      _this9 = _super5.call(this, 'div', id);
      _this9.playbackControlId = '';
      _this9.editControlId = '';
      _this9.isEnabled = true;
      _this9.autohideTimer = null;
      _this9.hideControlsTimeMillis = 3000;
      _this9.playbackControlInstance = null;
      _this9.videoOverlayButtons = null;
      _this9.buttonPlugins = [];
      _this9._hidden = false;
      _this9._over = false;
      _this9.viewControlId = id + '_view';
      _this9.playbackControlId = id + '_playback';
      _this9.editControlId = id + '_editor';

      _this9.addNode(new paella.PlaybackControl(_this9.playbackControlId));

      var thisClass = _assertThisInitialized(_this9);
      ...
      $(_this9.domElement).bind("mousemove", function (event) {
        thisClass._over = true;
      });
      $(_this9.domElement).bind("mouseout", function (event) {
      ...
      _this9.videoOverlayButtons = new paella.DomNode('div', id + '_videoOverlayButtonPlugins');
      _this9.videoOverlayButtons.domElement.className = 'videoOverlayButtonPlugins';

      _this9.videoOverlayButtons.domElement.setAttribute("role", "toolbar");

      _this9.addNode(_this9.videoOverlayButtons);

      paella.pluginManager.setTarget('videoOverlayButton', _assertThisInitialized(_this9));
      return _this9;
    }
...
*/
(function () {
  var LoaderContainer = /*#__PURE__*/function (_paella$DomNode) {
    _inherits(LoaderContainer, _paella$DomNode);

    var _super = _createSuper(LoaderContainer);
    ...
    function LoaderContainer(id) {
      ...
      _this.timer = null;
      _this.loader = null;
      _this.loaderPosition = 0;
      _this.loader = _this.addNode(new paella.DomNode('i', '', {
        width: "100px",
        height: "100px",
        color: "black",
        display: "block",
      ...
      _this.loader.domElement.className = "icon-spinner";
      paella.events.bind(paella.events.loadComplete, function (event, params) {
        _this.loadComplete(params);
      });
      _this.timer = new base.Timer(function (timer) {
        //thisClass.loaderPosition -= 128;
        //thisClass.loader.domElement.style.backgroundPosition = thisClass.loaderPosition + 'px';
        _this.loader.domElement.style.transform = "rotate(".concat(_this.loaderPosition, "deg");
        _this.loaderPosition += 45;
      }, 250);
      _this.timer.repeat = true;
      return _this;
    }
  ...
  var KeyPlugin = /*#__PURE__*/function (_paella$FastLoadPlugi) {
    _inherits(KeyPlugin, _paella$FastLoadPlugi);

    var _super2 = _createSuper(KeyPlugin);
    ...
    _createClass(KeyManager, [{
      ...
      value: function addPlugin(plugin) {
        ...
        if (plugin.checkEnabled(function (e) {
          _this2._pluginList.push(plugin);
  ...
  var InitDelegate = /*#__PURE__*/function () {
    ...
    _createClass(InitDelegate, [{
      ...
      value: function loadDictionary() {
        ...
        return new Promise(function (resolve) {
          base.ajax.get({
            url: _this.initParams.dictionaryUrl + "_" + base.dictionary.currentLanguage() + '.json'
      ...
      value: function loadConfig() {
        ...
        var loadAccessControl = function loadAccessControl(data) {
          ...
          _this2.initParams.accessControl = new AccessControlClass();
        };

        if (this.initParams.config) {
          return new Promise(function (resolve) {
            loadAccessControl(_this2.initParams.config);
            resolve(_this2.initParams.config);
          });
        } else if (this.initParams.loadConfig) {
          return new Promise(function (resolve, reject) {
            _this2.initParams.loadConfig(_this2.initParams.configUrl).then(function (data) {
          ...
          return new Promise(function (resolve, reject) {
            var configUrl = _this2.initParams.configUrl;
            var params = {};
...
(function () {
  var PaellaPlayer = /*#__PURE__*/function (_paella$PlayerBase) {
    ...
    var _super = _createSuper(PaellaPlayer);
    ...
    function PaellaPlayer(playerId) {
      ...
      _this = _super.call(this, playerId);
      _this.player = null;
      _this.videoIdentifier = '';
      _this.loader = null; // Video data:

      _this.videoData = null; // if initialization ok

      if (_this.playerId == playerId) {
        _this.loadPaellaPlayer();
    ...
    _createClass(PaellaPlayer, [{
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          _this2.videoContainer.play().then(function () {
            if (!_this2.controls) {
              _this2.showPlaybackBar();

              paella.events.trigger(paella.events.controlBarLoaded);

              _this2.controls.onresize();
            }
  ...
  var LazyThumbnailContainer = /*#__PURE__*/function (_paella$DomNode) {
    _inherits(LazyThumbnailContainer, _paella$DomNode);

    var _super2 = _createSuper(LazyThumbnailContainer);
    ...
    function LazyThumbnailContainer(src) {
      ...
      _this4 = _super2.call(this, 'img', 'lazyLoadThumbnailContainer', {});
      ...
      _this4.domElement.src = url.absoluteUrl;
      _this4.domElement.alt = "";
      _this4.container = LazyThumbnailContainer.GetIconElement();
  ...
  var PaellaPlayerLazy = /*#__PURE__*/function (_PaellaPlayer) {
    ...
    var _super3 = _createSuper(PaellaPlayerLazy);
    ...
    function PaellaPlayerLazy(playerId, initDelegate) {
      ...
      _this5 = _super3.call(this, playerId, initDelegate);
      g_lazyLoadInstance = _assertThisInitialized(_this5);
      return _this5;
    }
        ...
        if (this.videoIdentifier) {
          ...
          loader.loadVideo(function () {
            if (!loader.metadata.preview) {
              paella.load(_this6.playerId, paella.loaderFunctionParams);
              g_lazyLoadInstance = null; // Lazy load is disabled when the video has no preview
            } else {
              _this6.lazyLoadContainer = new LazyThumbnailContainer(loader.metadata.preview);
              document.body.appendChild(_this6.lazyLoadContainer.domElement);

              _this6.lazyLoadContainer.onClick(function () {
                _this6.lazyLoadContainer.destroyElements();

                _this6.lazyLoadContainer = null;
                _this6._onPlayClosure && _this6._onPlayClosure();
              });
...
(function () {
  ...
  var DefaultVideoLoader = /*#__PURE__*/function (_paella$VideoLoader) {
    ...
    var _super = _createSuper(DefaultVideoLoader);
      ...
      value: function loadVideo(onSuccess) {
        ...
        if (this._data) {
          ...
          loadVideoDelegate().then(function (data) {
            ...
            _this2.loadVideoData(_this2._data, onSuccess);
          });
        } else if (url) {
          var This = this;
          base.ajax.get({
  ...
  var DefaultInitDelegate = /*#__PURE__*/function (_paella$InitDelegate) {
    ...
    var _super2 = _createSuper(DefaultInitDelegate);
...
*/
(function () {
  var RightBarPlugin = /*#__PURE__*/function (_paella$DeferredLoadP) {
    _inherits(RightBarPlugin, _paella$DeferredLoadP);

    var _super = _createSuper(RightBarPlugin);
  ...
  var TabBarPlugin = /*#__PURE__*/function (_paella$DeferredLoadP2) {
    _inherits(TabBarPlugin, _paella$DeferredLoadP2);

    var _super2 = _createSuper(TabBarPlugin);
...
paella.addPlugin(function () {
  var FlexSkipPlugin = /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(FlexSkipPlugin, _paella$ButtonPlugin);

    var _super = _createSuper(FlexSkipPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$plugins$FlexS) {
    ...
    var _super2 = _createSuper(FlexSkipForwardPlugin);
...
paella.addPlugin(function () {
  ...
  return /*#__PURE__*/function (_paella$CaptionParser) {
    ...
    var _super = _createSuper(WebVTTParserPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$userTracking$) {
    ...
    var _super = _createSuper(xAPISaverPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl) {
    ...
    var _super = _createSuper(SingleStreamProfilePlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl2) {
    ...
    var _super2 = _createSuper(DualStreamProfilePlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl3) {
    ...
    var _super3 = _createSuper(TripleStreamProfilePlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl) {
    _inherits(TrimmingLoaderPlugin, _paella$EventDrivenPl);

    var _super = _createSuper(TrimmingLoaderPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(AirPlayPlugin, _paella$ButtonPlugin);

    var _super = _createSuper(AirPlayPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl) {
    _inherits(ArrowSlidesNavigator, _paella$EventDrivenPl);

    var _super = _createSuper(ArrowSlidesNavigator);
        ...
        return new Promise(function (resolve) {
          if (_this._frames.length < 1) {
            ...
            paella.player.videoContainer.duration().then(function (d) {
              ...
              if (!_this._frames.some(function (f1, i, array) {
                if (i + 1 == array.length) {
                  return;
                }

                var f0 = i == 0 ? f1 : _this._frames[i - 1];
                var f2 = _this._frames[i + 1];
                ...
                var t0 = _this._frames[_this._frames.length - 2].time;
                var t1 = _this._frames[_this._frames.length - 1].time;
                resolve({
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(AudioSelector, _paella$ButtonPlugin);

    var _super = _createSuper(AudioSelector);
    ...
    _createClass(AudioSelector, [{
      ...
      value: function checkEnabled(onSuccess) {
        ...
        this._mainPlayer.supportsMultiaudio().then(function (supports) {
          if (supports) {
            _this._legacyMode = false;
            return _this._mainPlayer.getAudioTracks();
          } else {
            _this._legacyMode = true;
            return paella.player.videoContainer.getAudioTags();
          }
        }).then(function (audioTracks) {
          if (_this._legacyMode) {
            _this._tags = audioTracks;
            return Promise.resolve();
          } else {
            _this._audioTracks = audioTracks;
            return _this._mainPlayer.getCurrentAudioTrack();
          }
        }).then(function (defaultAudioTrack) {
          if (_this._legacyMode) {
            onSuccess(_this._tags.length > 1);
          } else {
            _this._defaultAudioTrack = defaultAudioTrack;
            onSuccess(true);
          }
        });
      }
        ...
        if (this._legacyMode) {
          this._tags.forEach(function (tag, index) {
            buttonItems.push({
              ...
              value: tag,
              icon: "",
              className: _this2.getButtonItemClass(tag),
          ...
          this._audioTracks.forEach(function (track) {
            buttonItems.push({
              ...
              value: track.id,
              icon: "",
              className: _this2.getButtonItemClass(track.id),
              "default": track.id == _this2._defaultAudioTrack.id
            });
          });
        }
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl) {
    _inherits(BlackBoard2, _paella$EventDrivenPl);

    var _super = _createSuper(BlackBoard2);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl) {
    _inherits(BreaksPlayerPlugin, _paella$EventDrivenPl);

    var _super = _createSuper(BreaksPlayerPlugin);
    ...
    _createClass(BreaksPlayerPlugin, [{
      ...
      value: function onEvent(eventType, params) {
        ...
        paella.player.videoContainer.currentTime(true).then(function (currentTime) {
          ...
          var diff = Math.abs(currentTime - _this2.lastTime);

          _this2.checkBreaks(currentTime, diff >= 1 ? paella.events.seekToTime : paella.events.timeUpdate);
      ...
      value: function checkBreaks(currentTime, eventType) {
        ...
        if (this.breaks.some(function (breakItem) {
          if (breakItem.s <= currentTime && breakItem.e >= currentTime) {
            if (eventType == paella.events.timeUpdate && !_this3.status) {
              _this3.skipTo(breakItem.e);
            }
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$PlaybackCanva) {
    ...
    var _super = _createSuper(BufferedPlaybackCanvasPlugin);
...
paella.addPlugin(function () {
  ...
  /////////////////////////////////////////////////
  return /*#__PURE__*/function (_paella$CaptionParser) {
    _inherits(DFXPParserPlugin, _paella$CaptionParser);

    var _super = _createSuper(DFXPParserPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(CaptionsPlugin, _paella$ButtonPlugin);

    var _super = _createSuper(CaptionsPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl) {
    _inherits(CaptionsOnScreen, _paella$EventDrivenPl);

    var _super = _createSuper(CaptionsOnScreen);
        ...
        if (this.captions) {
          paella.player.videoContainer.trimming().then(function (trimming) {
            ...
            if (caption) {
              ...
              _this.innerContainer.innerText = caption.content;

              _this.moveCaptionsOverlay("auto");
            } else {
              _this.innerContainer.innerText = "";
...
(function () {
  function buildChromaVideoCanvas(stream, canvas) {
    var ChromaVideoCanvas = /*#__PURE__*/function (_bg$app$WindowControl) {
      _inherits(ChromaVideoCanvas, _bg$app$WindowControl);

      var _super = _createSuper(ChromaVideoCanvas);
      ...
      function ChromaVideoCanvas(stream) {
        ...
        _this = _super.call(this);
        _this.stream = stream;
        _this._chroma = bg.Color.White();
        _this._crop = new bg.Vector4(0.3, 0.01, 0.3, 0.01);
        _this._transform = bg.Matrix4.Identity().translate(0.6, -0.04, 0);
        _this._bias = 0.01;
        return _this;
      }
  ...
  var ChromaVideo = /*#__PURE__*/function (_paella$VideoElementB) {
    _inherits(ChromaVideo, _paella$VideoElementB);

    var _super2 = _createSuper(ChromaVideo);
    ...
    function ChromaVideo(id, stream, left, top, width, height, streamName) {
      ...
      _this4 = _super2.call(this, id, stream, 'canvas', left, top, width, height);
      _this4._posterFrame = null;
      _this4._currentQuality = null;
      _this4._autoplay = false;
      _this4._streamName = null;
      _this4._streamName = streamName || 'chroma';

      var This = _assertThisInitialized(_this4);

      if (_this4._stream.sources[_this4._streamName]) {
        _this4._stream.sources[_this4._streamName].sort(function (a, b) {
          return a.res.h - b.res.h;
        });
      }
    ...
    _createClass(ChromaVideo, [{
      ...
      value: function getVideoData() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this6._deferredAction(function () {
            resolve({
              duration: This.video.duration,
              currentTime: This.video.currentTime,
              volume: This.video.volume,
      ...
      value: function load() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this7._loadDeps().then(function () {
            var sources = _this7._stream.sources[_this7._streamName];

            if (_this7._currentQuality === null && _this7._videoQualityStrategy) {
              _this7._currentQuality = _this7._videoQualityStrategy.getQualityIndex(sources);
            }

            var stream = _this7._currentQuality < sources.length ? sources[_this7._currentQuality] : null;
            _this7.video = null;
            _this7.domElement.parentNode.style.backgroundColor = "transparent";

            if (stream) {
              _this7.canvasController = null;
              buildChromaVideoCanvas(stream, _this7.domElement).then(function (canvasController) {
                _this7.canvasController = canvasController;
                _this7.video = canvasController.video;

                _this7.video.pause();

                if (stream.crop) {
                  _this7.canvasController.crop = new bg.Vector4(stream.crop.left, stream.crop.top, stream.crop.right, stream.crop.bottom);
                }

                if (stream.displacement) {
                  _this7.canvasController.transform = bg.Matrix4.Translation(stream.displacement.x, stream.displacement.y, 0);
                }

                if (stream.chromaColor) {
                  _this7.canvasController.chroma = new bg.Color(stream.chromaColor[0], stream.chromaColor[1], stream.chromaColor[2], stream.chromaColor[3]);
                }

                if (stream.chromaBias) {
                  _this7.canvasController.bias = stream.chromaBias;
                }
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve, reject) {
          setTimeout(function () {
            ...
            sources.forEach(function (s) {
              index++;
              result.push(_this8._getQualityObject(index, s));
            });
            resolve(result);
          }, 10);
        });
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve) {
          var paused = _this9.video.paused;
          var sources = _this9._stream.sources[_this9._streamName];
          _this9._currentQuality = index < sources.length ? index : 0;
          var currentTime = _this9.video.currentTime;

          _this9.freeze().then(function () {
            _this9._ready = false;
            return _this9.load();
          }).then(function () {
            if (!paused) {
            ...
            $(_this9.video).on('seeked', function () {
              _this9.unFreeze();

              resolve();
              $(_this9.video).off('seeked');
            });
            _this9.video.currentTime = currentTime;
          });
        });
      }
    }, {
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve) {
          resolve(_this10._getQualityObject(_this10._currentQuality, _this10._stream.sources[_this10._streamName][_this10._currentQuality]));
        });
      }
    }, {
      key: "play",
      ...
      value: function setCurrentTime(time) {
        ...
        return this._deferredAction(function () {
          _this15.video.currentTime = time;
          $(_this15.video).on('seeked', function () {
            _this15.canvasController.postRedisplay();

            $(_this15.video).off('seeked');
          });
        });
      }
    }, {
      ...
      value: function unFreeze() {
        ...
        return this._deferredAction(function () {
          var c = document.getElementById(_this22.video.className + "canvas");
          $(c).remove();
        });
      }
    }, {
  ...
  var ChromaVideoFactory = /*#__PURE__*/function (_paella$VideoFactory) {
    _inherits(ChromaVideoFactory, _paella$VideoFactory);

    var _super3 = _createSuper(ChromaVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(extendedTabAdapterPlugin, _paella$ButtonPlugin);

    var _super = _createSuper(extendedTabAdapterPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(FootPrintsPlugin, _paella$ButtonPlugin);

    var _super = _createSuper(FootPrintsPlugin);
    ...
    _createClass(FootPrintsPlugin, [{
      ...
      value: function onTimeUpdate() {
        ...
        paella.player.videoContainer.currentTime().then(function (c) {
          ...
          if (_this.inPosition <= videoCurrentTime && videoCurrentTime <= _this.inPosition + _this.INTERVAL_LENGTH) {
            _this.outPosition = videoCurrentTime;

            if (_this.inPosition + _this.INTERVAL_LENGTH === _this.outPosition) {
              _this.trackFootPrint(_this.inPosition, _this.outPosition);

              _this.inPosition = _this.outPosition;
            }
          } else {
            _this.trackFootPrint(_this.inPosition, _this.outPosition);

            _this.inPosition = videoCurrentTime;
            _this.outPosition = videoCurrentTime;
          }
        });
      }
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$SearchService) {
    ...
    var _super = _createSuper(FrameCaptionsSearchPlugIn);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(FrameControlPlugin, _paella$ButtonPlugin);

    var _super2 = _createSuper(FrameControlPlugin);
    ...
    _createClass(FrameControlPlugin, [{
      ...
      value: function buildContent(domElement) {
        ...
        paella.events.bind(paella.events.setTrim, function (event, params) {
          _this.updateFrameVisibility(params.trimEnabled, params.trimStart, params.trimEnd);
        });
        paella.player.videoContainer.trimming().then(function (trimData) {
          _this.updateFrameVisibility(trimData.enabled, trimData.start, trimData.end);
        });
        paella.events.bind(paella.events.timeupdate, function (event, params) {
          return _this.onTimeUpdate(params.currentTime);
        });
      }
    }, {
      key: "showHiResFrame",
      ...
      value: function onMouseOut(event, frameData) {
        ...
        this._searchTimer = setTimeout(function (timer) {
          return _this2.removeHiResFrame();
      ...
      value: function onTimeUpdate(currentTime) {
        ...
        paella.player.videoContainer.trimming().then(function (trimming) {
          ...
          for (var i = 0; i < _this3.frames.length; ++i) {
            if (_this3.frames[i].frameData && _this3.frames[i].frameData.time <= time) {
              frame = _this3.frames[i];
            } else {
              break;
            }
          }

          if (_this3.currentFrame != frame && frame) {
            //this.navButtons.left.scrollContainer.scrollLeft += 100;
            if (_this3.currentFrame) _this3.currentFrame.className = 'frameControlItem';
            _this3.currentFrame = frame;
            _this3.currentFrame.className = 'frameControlItem current';
          }
        });
      }
    }, {
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(FullScreenPlugin, _paella$ButtonPlugin);
    ...
    _createClass(FullScreenPlugin, [{
      ...
      value: function action(button) {
        ...
        if (paella.player.isFullScreen()) {
          ...
          paella.player.pause();
          paella.player.videoContainer.currentTime().then(function (currentTime) {
            var obj = _this2.secondsToHours(currentTime);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(HelpPlugin, _paella$ButtonPlugin);
...
(function () {
  ...
  var HLSPlayer = /*#__PURE__*/function (_paella$Html5Video) {
    ...
    function HLSPlayer(id, stream, left, top, width, height) {
      ...
      return _super.call(this, id, stream, left, top, width, height, 'hls');
    }
    ...
    _createClass(HLSPlayer, [{
        ...
        return new Promise(function (resolve, reject) {
          ...
          if (_this.ready) {
            ...
            var eventFunction = function eventFunction() {
              processResult(action());
              $(_this.video).unbind('canplay');
              $(_this.video).unbind('loadedmetadata');
            ...
            $(_this.video).bind('canplay', eventFunction);
            $(_this.video).bind('loadedmetadata', eventFunction);
            ...
            var timerFunction = function timerFunction() {
              if (!_this.ready) {
                if (!_this._hls) {
                  ...
                  var src = _this.video.innerHTML;
                  _this.video.innerHTML = "";
                  _this.video.innerHTML = src;
      ...
      value: function setupHls(video, url) {
        ...
        return new Promise(function (resolve, reject) {
          _this2._loadDeps().then(function (Hls) {
            if (Hls.isSupported()) {
              var cfg = _this2.config; //cfg.autoStartLoad = false;

              _this2._hls = new Hls(cfg);

              _this2._hls.loadSource(url);

              _this2._hls.attachMedia(video);

              _this2.autoQuality = true;

              _this2._hls.on(Hls.Events.LEVEL_SWITCHED, function (ev, data) {
                _this2._qualities = _this2._qualities || [];
                _this2._qualityIndex = _this2.autoQuality ? _this2._qualities.length - 1 : data.level;
                paella.events.trigger(paella.events.qualityChanged, {});
                if (console && console.log) console.log("HLS: quality level changed to ".concat(data.level));
              });

              _this2._hls.on(Hls.Events.ERROR, function (event, data) {
                if (data.fatal) {
                  switch (data.type) {
              ...
              _this2._hls.on(Hls.Events.MANIFEST_PARSED, function () {
                if (!cfg.autoStartLoad) {
                  _this2._hls.startLoad();
                } // Fixes hls.js problems when loading the initial quality level


                _this2._hls.currentLevel = _this2._hls.levels.length >= initialQualityLevel ? initialQualityLevel : -1;
                setTimeout(function () {
                  return _this2._hls.currentLevel = -1;
                }, 1000);
                resolve(video);
              });
            } else {
      ...
      value: function webGlDidLoad() {
        ...
        bg.utils.HTTPResourceProvider.AddVideoLoader('m3u8', function (url, onSuccess, onFail) {
          ...
          _this3.setupHls(video, url).then(function () {
      ...
      value: function loadVideoStream(canvasInstance, stream) {
        ...
        return canvasInstance.loadVideo(this, stream, function (videoElem) {
          return _this4.setupHls(videoElem, stream.src);
        });
      }
    }, {
      key: "supportsMultiaudio",
      value: function supportsMultiaudio() {
        ...
        return this._deferredAction(function () {
          if (base.userAgent.system.iOS) {
            return _this5.video.audioTracks.length > 1;
          } else {
            return _this5._hls.audioTracks.length > 1;
          }
        });
      }
    }, {
      ...
      value: function getAudioTracks() {
        ...
        return this._deferredAction(function () {
          if (base.userAgent.system.iOS) {
            var result = [];
            Array.from(_this6.video.audioTracks).forEach(function (t) {
              result.push({
                id: t.id,
                groupId: "",
                name: t.label,
            ...
            return _this6._hls.audioTracks;
          }
        });
      }
    }, {
      ...
      value: function setCurrentAudioTrack(trackId) {
        ...
        return this._deferredAction(function () {
          if (base.userAgent.system.iOS) {
            var found = false;
            Array.from(_this7.video.audioTracks).forEach(function (track) {
              if (track.id == trackId) {
                found = true;
                track.enabled = true;
              } else {
            ...
            if (_this7._hls.audioTracks.some(function (track) {
              return track.id == trackId;
            })) {
              _this7._hls.audioTrack = trackId;
              return true;
            } else {
              return false;
            }
      ...
      value: function getCurrentAudioTrack() {
        ...
        return this._deferredAction(function () {
          if (base.userAgent.system.iOS) {
            var result = null;
            Array.from(_this8.video.audioTracks).some(function (t) {
              if (t.enabled) {
                result = t;
                return true;
              }
            ...
            _this8._hls.audioTracks.some(function (t) {
              if (t.id == _this8._hls.audioTrack) {
                _result = t;
                return true;
              }
            });
      ...
      value: function getQualities() {
        ...
        if (base.userAgent.system.iOS) // ||
          ...
          var This = this;
          return new Promise(function (resolve) {
            if (!_this9._qualities || _this9._qualities.length == 0) {
              This._qualities = [];
      ...
      value: function printQualityes() {
        ...
        return new Promise(function (resolve, reject) {
          _this10.getCurrentQuality().then(function (cq) {
            return _this10.getNextQuality();
          }).then(function (nq) {
            resolve();
          });
        });
      ...
      value: function getNextQuality() {
        ...
        return new Promise(function (resolve, reject) {
          var index = _this11.qualityIndex;
          resolve(_this11._qualities[index]);
        });
      }
    }, {
      key: "getCurrentQuality",
      value: function getCurrentQuality() {
        ...
        if (base.userAgent.system.iOS) // ||
          ...
          return new Promise(function (resolve, reject) {
            resolve(_this12._qualities[_this12.qualityIndex]);
          });
        }
      }
    }]);
  ...
  var HLSVideoFactory = /*#__PURE__*/function (_paella$VideoFactory) {
    _inherits(HLSVideoFactory, _paella$VideoFactory);

    var _super2 = _createSuper(HLSVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$KeyPlugin) {
    ...
    var _super = _createSuper(DefaultKeyPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$VideoOverlayB) {
    ...
    var _super = _createSuper(LegalPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$VideoOverlayB) {
    _inherits(LiveStreamIndicator, _paella$VideoOverlayB);

    var _super = _createSuper(LiveStreamIndicator);
...
(function () {
  var MpegDashVideo = /*#__PURE__*/function (_paella$Html5Video) {
    _inherits(MpegDashVideo, _paella$Html5Video);

    var _super = _createSuper(MpegDashVideo);
    ...
    function MpegDashVideo(id, stream, left, top, width, height) {
      ...
      _this = _super.call(this, id, stream, left, top, width, height, 'mpd');
      _this._posterFrame = null;
      _this._player = null;
      return _this;
    }
    ...
    _createClass(MpegDashVideo, [{
      ...
      value: function loadVideoStream(canvasInstance, stream) {
        ...
        return canvasInstance.loadVideo(this, stream, function (videoElem) {
          return new Promise(function (resolve, reject) {
            _this2._loadDeps().then(function () {
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve) {
          _this3._deferredAction(function () {
            if (!_this3._qualities) {
              _this3._qualities = [];

              _this3._player.getBitrateInfoListFor("video").sort(function (a, b) {
                return a.bitrate - b.bitrate;
              }).forEach(function (item, index, bitrates) {
                _this3._qualities.push(_this3._getQualityObject(item, index, bitrates));
              });

              _this3.autoQualityIndex = _this3._qualities.length;

              _this3._qualities.push({
                index: _this3.autoQualityIndex,
                res: {
                  w: null,
                  h: null
                },
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve, reject) {
          var currentQuality = _this4._player.getQualityFor("video");

          if (index == _this4.autoQualityIndex) {
            _this4._player.setAutoSwitchQuality(true);

            resolve();
          } else if (index != currentQuality) {
            _this4._player.setAutoSwitchQuality(false);

            _this4._player.off(dashjs.MediaPlayer.events.METRIC_CHANGED);

            _this4._player.on(dashjs.MediaPlayer.events.METRIC_CHANGED, function (a, b) {
              if (a.type == "metricchanged") {
                if (currentQuality != _this4._player.getQualityFor("video")) {
                  currentQuality = _this4._player.getQualityFor("video");
                  resolve();
                }
              }
            });

            _this4._player.setQualityFor("video", index);
          } else {
            resolve();
          }
        });
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve, reject) {
          if (_this5._player.getAutoSwitchQuality()) {
            // auto quality
            resolve({
              index: _this5.autoQualityIndex,
              res: {
                w: null,
                h: null
              },
            ...
            var index = _this5._player.getQualityFor("video");

            resolve(_this5._getQualityObject(_this5._qualities[index], index, _this5._player.getBitrateInfoListFor("video")));
          }
        });
      }
    }, {
  ...
  var MpegDashVideoFactory = /*#__PURE__*/function (_paella$VideoFactory) {
    _inherits(MpegDashVideoFactory, _paella$VideoFactory);

    var _super2 = _createSuper(MpegDashVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(MultipleQualitiesPlugin, _paella$ButtonPlugin);

    var _super = _createSuper(MultipleQualitiesPlugin);
    ...
    _createClass(MultipleQualitiesPlugin, [{
      ...
      value: function getMenuContent() {
        ...
        this._available.forEach(function (q, index) {
          ...
          if (resH >= _this3.config.minVisibleQuality || resH <= 0) {
            buttonItems.push({
              id: q.shortLabel(),
              title: q.shortLabel(),
              value: index,
              icon: "",
              className: _this3.getButtonItemClass(q.shortLabel()),
              "default": false
            });
          }
        });
      ...
      value: function menuItemSelected(itemData) {
        ...
        paella.player.videoContainer.setQuality(itemData.value).then(function () {
          paella.player.controls.hidePopUp(_this4.getName());

          _this4.setQualityLabel();
        });
      }
    }, {
      key: "setQualityLabel",
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(PIPModePlugin, _paella$ButtonPlugin);

    var _super = _createSuper(PIPModePlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(PlayPauseButtonPlugin, _paella$ButtonPlugin);

    var _super = _createSuper(PlayPauseButtonPlugin);
    ...
    function PlayPauseButtonPlugin() {
      ...
      _this = _super.call(this);
      _this.playIconClass = 'icon-play';
      _this.replayIconClass = 'icon-loop2';
      _this.pauseIconClass = 'icon-pause';
      _this.playSubclass = 'playButton';
      _this.pauseSubclass = 'pauseButton';
      return _this;
    }
    ...
    _createClass(PlayPauseButtonPlugin, [{
      ...
      value: function setup() {
        ...
        paella.events.bind(paella.events.play, function (event) {
          _this2.changeIconClass(_this2.pauseIconClass);

          _this2.changeSubclass(_this2.pauseSubclass);

          _this2.setToolTip(paella.dictionary.translate("Pause"));
        });
        paella.events.bind(paella.events.pause, function (event) {
          _this2.changeIconClass(_this2.playIconClass);

          _this2.changeSubclass(_this2.playSubclass);

          _this2.setToolTip(paella.dictionary.translate("Play"));
        });
        paella.events.bind(paella.events.ended, function (event) {
          _this2.changeIconClass(_this2.replayIconClass);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl) {
    _inherits(PlayButtonOnScreen, _paella$EventDrivenPl);

    var _super = _createSuper(PlayButtonOnScreen);
    ...
    function PlayButtonOnScreen() {
      ...
      _this = _super.call(this);
      _this.containerId = 'paella_plugin_PlayButtonOnScreen';
    ...
    _createClass(PlayButtonOnScreen, [{
      ...
      value: function checkEnabled(onSuccess) {
        ...
        paella.data.read('relatedVideos', {
          ...
          _this2.showOnEnd = !Array.isArray(data) || data.length == 0;
        });
      ...
      value: function setup() {
        ...
        $(this.container).click(function () {
          return _this3.onPlayButtonClick();
        });
      }
    }, {
      key: "getEvents",
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(PlaybackRate, _paella$ButtonPlugin);
      ...
      value: function getMenuContent() {
        ...
        this.available_rates.forEach(function (rate) {
          ...
          buttonItems.push({
            ...
            value: rate,
            icon: "",
            className: _this.getButtonItemClass(profileName),
            "default": rate == 1.0
          });
        });
        return buttonItems;
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(RatePlugin, _paella$ButtonPlugin);

    var _super = _createSuper(RatePlugin);
    ...
    _createClass(RatePlugin, [{
      ...
      value: function checkEnabled(onSuccess) {
        ...
        paella.data.read('rate', {
          ...
          if (data && _typeof(data) == 'object') {
            _this.score = Number(data.mean).toFixed(1);
            _this.count = data.count;
            _this.myScore = data.myScore;
            _this.canVote = data.canVote;
          }
      ...
      value: function vote(score) {
        ...
        paella.data.write('rate', {
          ...
          paella.data.read('rate', {
            ...
            if (data && _typeof(data) == 'object') {
              _this2.score = Number(data.mean).toFixed(1);
              _this2.count = data.count;
              _this2.myScore = data.myScore;
              _this2.canVote = data.canVote;
            }

            _this2.updateHeader();

            _this2.updateRateButtons();
          });
        });
      }
    }, {
      ...
      value: function updateVote() {
        ...
        this.buttons.forEach(function (item, index) {
          item.className = index < _this3.myScore ? "starButton glyphicon glyphicon-star" : "starButton glyphicon glyphicon-star-empty";
        });
      }
    }]);
...
paella.addDataDelegate("relatedVideos", function () {
  return /*#__PURE__*/function (_paella$DataDelegate) {
    _inherits(RelatedVideoDataDelegate, _paella$DataDelegate);

    var _super = _createSuper(RelatedVideoDataDelegate);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl) {
    _inherits(RelatedVideoPlugin, _paella$EventDrivenPl);

    var _super2 = _createSuper(RelatedVideoPlugin);
    ...
    _createClass(RelatedVideoPlugin, [{
      ...
      value: function checkEnabled(onSuccess) {
        ...
        paella.data.read('relatedVideos', {
          ...
          _this._relatedVideos = data;
          onSuccess(Array.isArray(_this._relatedVideos) && _this._relatedVideos.length > 0);
        });
      }
    }, {
      key: "setup",
...
(function () {
  var RTMPVideo = /*#__PURE__*/function (_paella$VideoElementB) {
    _inherits(RTMPVideo, _paella$VideoElementB);

    var _super = _createSuper(RTMPVideo);
    ...
    function RTMPVideo(id, stream, left, top, width, height) {
      ...
      _this = _super.call(this, id, stream, 'div', left, top, width, height);
      _this._posterFrame = null;
      _this._currentQuality = null;
      _this._duration = 0;
      _this._paused = true;
      _this._streamName = null;
      _this._flashId = null;
      _this._swfContainer = null;
      _this._flashVideo = null;
      _this._volume = 1;
      _this._flashId = id + 'Movie';
      _this._streamName = 'rtmp';

      var This = _assertThisInitialized(_this);

      _this._stream.sources.rtmp.sort(function (a, b) {
        return a.res.h - b.res.h;
      });
    ...
    _createClass(RTMPVideo, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          if (_this2.ready) {
            ...
            $(_this2.swfContainer).bind('paella:flashvideoready', function () {
              _this2._ready = true;
              resolve(action());
            });
          }
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve, reject) {
          setTimeout(function () {
            var result = [];
            var sources = _this4._stream.sources.rtmp;
            var index = -1;
            sources.forEach(function (s) {
              index++;
              result.push(_this4._getQualityObject(index, s));
            });
            resolve(result);
          }, 50);
        });
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve, reject) {
          var paused = _this5._paused;
          var sources = _this5._stream.sources.rtmp;
          _this5._currentQuality = index < sources.length ? index : 0;
          var source = sources[index];
          _this5._ready = false;
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve, reject) {
          resolve(_this6._getQualityObject(_this6._currentQuality, _this6._stream.sources.rtmp[_this6._currentQuality]));
        });
      }
    }, {
      key: "play",
  ...
  var RTMPVideoFactory = /*#__PURE__*/function (_paella$VideoFactory) {
    _inherits(RTMPVideoFactory, _paella$VideoFactory);

    var _super2 = _createSuper(RTMPVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$SearchService) {
    _inherits(CaptionsSearchPlugIn, _paella$SearchService);

    var _super = _createSuper(CaptionsSearchPlugIn);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(SearchPlugin, _paella$ButtonPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(SharePlugin, _paella$ButtonPlugin);

    var _super = _createSuper(SharePlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$VideoOverlayB) {
    _inherits(ShowEditorPlugin, _paella$VideoOverlayB);

    var _super = _createSuper(ShowEditorPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(ThemeChooserPlugin, _paella$ButtonPlugin);

    var _super = _createSuper(ThemeChooserPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$PlaybackCanva) {
    _inherits(TimeMarksPlaybackCanvasPlugin, _paella$PlaybackCanva);

    var _super = _createSuper(TimeMarksPlaybackCanvasPlugin);
        ...
        if (this._hasSlides) {
          this._frameKeys.forEach(function (l) {
            ...
            if (timeInstant > 0 && timeInstant < videoData.trimming.duration) {
              ...
              _this.drawTimeMark(context, left, height);
            }
          });
        }
      }
...
paella.addDataDelegate("cameraTrack", function () {
  return /*#__PURE__*/function (_paella$DataDelegate) {
    _inherits(TrackCameraDataDelegate, _paella$DataDelegate);

    var _super = _createSuper(TrackCameraDataDelegate);
...
(function () {
  ...
  paella.addPlugin(function () {
    return /*#__PURE__*/function (_paella$EventDrivenPl) {
      _inherits(Track4KPlugin, _paella$EventDrivenPl);

      var _super2 = _createSuper(Track4KPlugin);
      ...
      function Track4KPlugin() {
        ...
        g_track4kPlugin = _assertThisInitialized(_this);
        _this._videoData = {};
        _this._trackData = [];
        _this._enabled = true;
        return _this;
      ...
      _createClass(Track4KPlugin, [{
        ...
        value: function checkEnabled(cb) {
          ...
          paella.data.read('cameraTrack', {
            ...
            if (data) {
              _this2._videoData.width = data.width;
              _this2._videoData.height = data.height;
              _this2._videoData.originalWidth = data.originalWidth;
              _this2._videoData.originalHeight = data.originalHeight;
              _this2._trackData = data.positions;
  ...
  paella.addPlugin(function () {
    return /*#__PURE__*/function (_paella$ButtonPlugin) {
      _inherits(VideoZoomTrack4KPlugin, _paella$ButtonPlugin);

      var _super3 = _createSuper(VideoZoomTrack4KPlugin);
      ...
      _createClass(VideoZoomTrack4KPlugin, [{
        ...
        value: function buildContent(domElement) {
          ...
          domElement.appendChild(getZoomButton('zoom-auto', function (evt) {
            ...
            paella.player.controls.hidePopUp(_this3.getName());
          }, "auto"));
        }
      }, {
        key: "zoomIn",
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$userTracking$) {
    _inherits(ElasticsearchSaverPlugin, _paella$userTracking$);

    var _super = _createSuper(ElasticsearchSaverPlugin);
    ...
    _createClass(ElasticsearchSaverPlugin, [{
      ...
      value: function log(event, params) {
        ...
        paella.player.videoContainer.currentTime().then(function (t) {
          ...
          paella.ajax.post({
            url: _this._url + "/" + _this._index + "/" + _this._type + "/",
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$userTracking$) {
    _inherits(GoogleAnalyticsTracking, _paella$userTracking$);

    var _super = _createSuper(GoogleAnalyticsTracking);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$userTracking$) {
    _inherits(PiwikAnalyticsTracking, _paella$userTracking$);

    var _super = _createSuper(PiwikAnalyticsTracking);
...
(function () {
  paella.addCanvasPlugin("video360", true, true, function () {
    return /*#__PURE__*/function (_paella$WebGLCanvas) {
      ...
      var _super = _createSuper(Video360Canvas);

      function Video360Canvas(stream) {
        _classCallCheck(this, Video360Canvas);

        return _super.call(this, stream);
      }
...
(function () {
  ...
  paella.addCanvasPlugin("video360Theta", true, true, function () {
    return /*#__PURE__*/function (_paella$WebGLCanvas) {
      _inherits(Video360ThetaCanvas, _paella$WebGLCanvas);

      var _super = _createSuper(Video360ThetaCanvas);
...
paella.addDataDelegate('metadata', function () {
  return /*#__PURE__*/function (_paella$DataDelegate) {
    _inherits(VideoManifestMetadataDataDelegate, _paella$DataDelegate);

    var _super = _createSuper(VideoManifestMetadataDataDelegate);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$VideoOverlayB) {
    _inherits(VideoDataPlugin, _paella$VideoOverlayB);

    var _super2 = _createSuper(VideoDataPlugin);
...
paella.addPlugin(function () {
  ...
  return /*#__PURE__*/function (_paella$VideoOverlayB) {
    _inherits(VideoZoomPlugin, _paella$VideoOverlayB);

    var _super = _createSuper(VideoZoomPlugin);
    ...
    _createClass(VideoZoomPlugin, [{
      ...
      value: function setup() {
        ...
        players.forEach(function (player, index) {
          if (player.allowZoom()) {
            _this._available = player.zoomAvailable();
            _this._visible = _this._available;
            setupButtons.apply(_this, [player]);
            player.supportsCaptureFrame().then(function (supports) {
              if (supports) {
                var thumbContainer = document.createElement('div');
                thumbContainer.className = "zoom-container";
                var thumb = getThumbnailContainer.apply(_this, [index]);
                var zoomRect = getZoomRect.apply(_this);

                _this.button.appendChild(thumbContainer);

                thumbContainer.appendChild(thumb);
                thumbContainer.appendChild(zoomRect);
                $(thumbContainer).hide();

                _this._thumbnails.push({
                  player: player,
        ...
        paella.events.bind(paella.events.play, function (evt) {
          var updateThumbs = function updateThumbs() {
            _this._thumbnails.forEach(function (item) {
        ...
        paella.events.bind(paella.events.videoZoomChanged, function (evt, target) {
          _this._thumbnails.some(function (thumb) {
        ...
        paella.events.bind(paella.events.zoomAvailabilityChanged, function (evt, target) {
          _this._available = target.available;
          _this._visible = target.available;
          checkVisibility.apply(_this);
        });
        paella.events.bind(paella.events.controlBarDidHide, function () {
          _this._visible = false;
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(VideoZoomToolbarPlugin, _paella$ButtonPlugin);

    var _super2 = _createSuper(VideoZoomToolbarPlugin);
    ...
    _createClass(VideoZoomToolbarPlugin, [{
      ...
      value: function buildContent(domElement) {
        ...
        paella.events.bind(paella.events.videoZoomChanged, function (evt, target) {
          _this2.setText(Math.round(target.video.zoom) + "%");
        });
        this.setText("100%");
        ...
        domElement.appendChild(getZoomButton('zoom-in', function (evt) {
          _this2.targetPlayer.zoomIn();
        }));
        domElement.appendChild(getZoomButton('zoom-out', function (evt) {
          _this2.targetPlayer.zoomOut();
        }));
      }
    }]);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(ViewModePlugin, _paella$ButtonPlugin);

    var _super = _createSuper(ViewModePlugin);
    ...
    _createClass(ViewModePlugin, [{
      ...
      value: function getMenuContent() {
        ...
        paella.profiles.profileList.forEach(function (profileData, index) {
          ...
          if (_this.active_profiles) {
            var active = false;

            _this.active_profiles.some(function (ap) {
              if (ap == profile) {
                active = ap;
                return true;
              }
          ...
          var url = _this.getButtonItemIcon(profileData);
          ...
          buttonItems.push({
            ...
            icon: url,
            className: _this.getButtonItemClass(profileData.id),
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin) {
    _inherits(VolumeRangePlugin, _paella$ButtonPlugin);

    var _super = _createSuper(VolumeRangePlugin);
    ...
    _createClass(VolumeRangePlugin, [{
      ...
      value: function getExpandableContent() {
        ...
        var updateMasterVolume = function updateMasterVolume() {
          ...
          var slaveVolume = 0;
          _this._control_NotMyselfEvent = false;
      ...
      value: function updateClass() {
        ...
        paella.player.videoContainer.volume().then(function (volume) {
          ...
          _this2.changeIconClass(selected);
        });
      }
    }]);
...
(function () {
  var WebmVideoFactory = /*#__PURE__*/function (_paella$VideoFactory) {
    _inherits(WebmVideoFactory, _paella$VideoFactory);

    var _super = _createSuper(WebmVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl) {
    _inherits(WindowTitlePlugin, _paella$EventDrivenPl);

    var _super = _createSuper(WindowTitlePlugin);
...
(function () {
  var YoutubeVideo = /*#__PURE__*/function (_paella$VideoElementB) {
    _inherits(YoutubeVideo, _paella$VideoElementB);
    ...
    _createClass(YoutubeVideo, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          _this2._readyPromise.then(function () {
            resolve(action());
          }, function () {
            reject();
          });
      ...
      value: function getVideoData() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          var stream = _this3._stream.sources.youtube[0];
      ...
      value: function load() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this4._qualityListReadyPromise = $.Deferred();
          paella.youtubePlayerVars.apiReadyPromise.then(function () {
            var stream = _this4._stream.sources.youtube[0];

            if (stream) {
              // TODO: poster frame
              _this4._youtubePlayer = new YT.Player(This.identifier, {
                height: '390',
                width: '640',
                videoId: stream.id,
                playerVars: {
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve, reject) {
          _this5._qualityListReadyPromise.then(function (q) {
            for (var key in _this5._qualities) {
              var searchQ = _this5._qualities[key];

              if (_typeof(searchQ) == "object" && searchQ.index == index) {
                _this5.video.setPlaybackQuality(searchQ.label);
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve, reject) {
          _this6._qualityListReadyPromise.then(function (q) {
            resolve(_this6._qualities[_this6.video.getPlaybackQuality()]);
          });
        });
      }
    }, {
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          ...
          new base.Timer(function (timer) {
            var q = _this7.video.getAvailableQualityLevels();

            if (q.length) {
              timer.repeat = false;

              _this7._qualityListReadyPromise.resolve(q);
      ...
      value: function pause() {
        ...
        return this._deferredAction(function () {
          _this8._playing = false;

          _this8.video.pauseVideo();
        });
      }
    }, {
      key: "isPaused",
      ...
      value: function duration() {
        ...
        return this._deferredAction(function () {
          return _this10.video.getDuration();
        });
      }
    }, {
      key: "setCurrentTime",
      ...
      value: function currentTime() {
        ...
        return this._deferredAction(function () {
          return _this12.video.getCurrentTime();
        });
      }
    }, {
      key: "setVolume",
      value: function setVolume(volume) {
        ...
        return this._deferredAction(function () {
          _this13.video.setVolume && _this13.video.setVolume(volume * 100);
        });
      }
    }, {
      key: "volume",
      value: function volume() {
        ...
        return this._deferredAction(function () {
          return _this14.video.getVolume() / 100;
        });
      }
    }, {
      key: "setPlaybackRate",
      value: function setPlaybackRate(rate) {
        ...
        return this._deferredAction(function () {
          _this15.video.playbackRate = rate;
        });
      }
    }, {
      key: "playbackRate",
      value: function playbackRate() {
        ...
        return this._deferredAction(function () {
          return _this16.video.playbackRate;
        });
      }
    }, {
      key: "goFullScreen",
      ...
      value: function unFreeze() {
        ...
        return this._deferredAction(function () {
          var c = document.getElementById(_this18.video.className + "canvas");
          $(c).remove();
        });
      }
    }, {
      ...
      value: function freeze() {
        ...
        return this._deferredAction(function () {
          var canvas = document.createElement("canvas");
          canvas.id = _this19.video.className + "canvas";
          canvas.width = _this19.video.videoWidth;
          canvas.height = _this19.video.videoHeight;
          canvas.style.cssText = _this19.video.style.cssText;
          canvas.style.zIndex = 2;
          var ctx = canvas.getContext("2d");
          ctx.drawImage(_this19.video, 0, 0, Math.ceil(canvas.width / 16) * 16, Math.ceil(canvas.height / 16) * 16); //Draw image

          _this19.video.parentElement.appendChild(canvas);
        });
      }
    }, {
      key: "unload",
  ...
  var YoutubeVideoFactory = /*#__PURE__*/function (_paella$VideoFactory) {
    _inherits(YoutubeVideoFactory, _paella$VideoFactory);

    var _super2 = _createSuper(YoutubeVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$userTracking$) {
    _inherits(MatomoTracking, _paella$userTracking$);
...
paella.addPlugin(function () {
  var self = this;
  return /*#__PURE__*/function (_paella$userTracking$) {
    _inherits(X5gonTracking, _paella$userTracking$);

    var _super = _createSuper(X5gonTracking);
